---
layout: post
title: CO_2 sensor on Raspberry Pi with MQTT and Home Assistant integration
language: en-DE
...
However SCD4x doesn't work with i2c-tools ([ref](https://cdn.sparkfun.com/assets/d/4/9/a/d/Sensirion_CO2_Sensors_SCD4x_Datasheet.pdf))

We can read write directly instead ([ref](https://www.kernel.org/doc/Documentation/i2c/dev-interface))
